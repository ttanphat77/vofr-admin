...
export class CategoryComponent {
    ...
    loadMasterCategory() {
        var listMaster = this.categories.filter((cate) => { return cate.masterCategoryId == null });
    ...
    handleLoadSubCategory(category: Category) {
        if (category) {
            ...
            var listSub = this.categories.filter((cate) => { return cate.masterCategoryId == this.chosenCategory.id });
